    ...
    <div class="row">
        ...
        <div class="panel-body">
            <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <select class="form-control input-sm mb-md" name="iconnet_id">
                        <option></option>
                        <?php 
                        $project = $conn->query("SELECT * FROM tbl_iconnet where status < 2");
                        while($row= $project->fetch_assoc()):
                        ?>
                        <option value="<?php echo $row['id'] ?>" ><?php echo ucwords($row['sektor']),' ',ucwords($row['periode']) ?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
            </div>
