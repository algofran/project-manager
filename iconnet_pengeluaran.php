...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Pengeluaran Iconnet</span></li>
            </ol>
    ...
    <div class="row">
        ...
        <form  class="form-horizontal mb-lg" action="_exp_iconnet.php" method="post">			
        <div class="panel-body">
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : null ?>">
        <input type="hidden" name="iconnet_id" value="<?php echo isset($iconnet_id) ? $iconnet_id : null ?>">
            ...
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <button class="btn btn-default" onclick="location.href='index.php?page=iconnet_detail&pid=<?php echo $iconnet_id ?>'">Cancel</button>
                    </div>
                </div>
            </footer>
