                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-group">
                                ...
                                <select class="form-control mb-md" name="pembayaran">
                                    <option value="1" <?php echo isset($pembayaran) && $pembayaran == 1 ? 'selected' : '' ?>>PT. PLN (PERSERO) UNIT INDUK WILAYAH SULSELRABAR</option>
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-group">
                                ...
                                <div class="input-daterange input-group" data-plugin-datepicker="" data-date-format="yyyy-mm-dd">
                                    ...
                                    <input type="text" class="form-control" name="start_date" value="<?php echo isset($start_date) ? date("Y-m-d",strtotime($start_date)) : '' ?>">
                                    <span class="input-group-addon">s/d</span>
                                    <input type="text" class="form-control" name="end_date" value="<?php echo isset($end_date) ? date("Y-m-d",strtotime($end_date)) : '' ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="payment" value="<?php echo isset($payment) ? $payment : '' ?>">
                                </div>
                            </div>  
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control mb-md" name="status">
                                    ...
                                    <option value="4" <?php echo isset($status) && $status == 4 ? 'selected' : '' ?>>Cancel</option>
                                </select>
                            </div>
                        </div>
