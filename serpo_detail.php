...
$qry = $conn->query("SELECT * FROM tbl_serpo where id = ".$_GET['pid'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
...
<section role="main" class="content-body">
    ...
    <section class="panel panel-featured panel-featured-primary">				
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">							
                    <dl>
                        <dt><b class="border-bottom border-primary">Nama Serpo</b></dt>
                        <dd><p class="text-primary text-bold"><?php echo $paket_tag[$paket] ?></p></dd>
                    </dl>
                </div>
                <div class="col-md-6">
                <dl>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php $exp = $conn->query("SELECT sum(cost) as costs from serpo_exp where serpo_id=".$id)->fetch_object()->costs ?>
        ...
        <section class="panel panel-featured panel-featured-success">	
            <header class="panel-heading">
                ...
                <DIV class="col-md-6">
                    ...
                    <a class="btn btn-block btn-sm btn-default" href="./index.php?page=task_baru&pid=<?php echo $id ?>"><i class="fa fa-plus"></i> Tambah Tagihan</a>
                </div>
                </div>
                </div>
            </header>	
    ...
    <section class="panel panel-featured panel-featured-danger">	
            <header class="panel-heading">
                ...
                <DIV class="col-md-6">
                    <div class="col-md-6 col-md-offset-6">
                    <a class="btn btn-block btn-sm btn-default" href="./index.php?page=serpo_pengeluaran&pid=<?php echo $id ?>"><i class="fa fa-plus"></i> Tambah Pengeluaran</a>
                </div>
                </div>
                </div>
            </header>	
            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							<?php 
							$i = 1;
							$tasks = $conn->query("SELECT p.*,concat(u.firstname,' ',u.lastname) as uname FROM serpo_exp p left join users u on u.id = p.user_id where p.serpo_id = {$id} order by p.date desc");
							while($row=$tasks->fetch_assoc()):
							?>
								<tr id="<?php echo $row['id'] ?>">
			                        <td class="text-center"><?php echo $i++ ?></td>
			                        ...
			                        <td class="center actions-hover actions-fade">
                                        ...
                                        <a href="./index.php?page=serpo_exp_edit&id=<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></a>
                                        <a href="./serpo_exp_del.php?id=<?php echo $row['id'] ?>&pid=<?php echo $id ?>" onclick="return confirm('Anda yakin ingin menghapus item pengeluaran ini?')"><i class="fa fa-trash-o remove"></i></a>
                                    </td>
		                    	</tr>
							<?php 
							endwhile;
