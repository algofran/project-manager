...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Pengeluaran Serpo</span></li>
            </ol>
    ...
    <div class="row">
        ...
        <form  class="form-horizontal mb-lg" action="_exp_serpo.php" method="post">			
        <div class="panel-body">
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : null ?>">
        <input type="hidden" name="serpo_id" value="<?php echo isset($serpo_id) ? $serpo_id : null ?>">
            ...
            <label class="col-sm-3 control-label">Tanggal</label>
                <div class="col-sm-9">              
                    <div class="input-group">
                        ...
                        <input type="text" name="date" data-date-format="yyyy-mm-dd" data-plugin-datepicker="" value="<?php echo isset($date) ? date("Y-m-d",strtotime($date)) : '' ?>" class="form-control"></input>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control mb-md" name="subject">
                        ...
                        <option value="Biaya Service/Sparepart" <?php echo isset($subject) && $subject == "Biaya Service/Sparepart" ? 'selected' : '' ?>>Biaya Service/Sparepart</option>
                        <option value="Biaya BBM" <?php echo isset($subject) && $subject == "Biaya BBM" ? 'selected' : '' ?>>Biaya BBM</option>
            ...
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <button class="btn btn-default" onclick="location.href='index.php?page=serpo_detail&pid=<?php echo $serpo_id ?>'">Cancel</button>
                    </div>
                </div>
            </footer>
