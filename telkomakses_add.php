...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Tambah Telkom Akses</span></li>
            </ol>
    ...
    <div class="row">
        ...
        <form  class="form-horizontal mb-lg" action="_manage_telkomakses.php" method="post">			
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">Jumlah WO</label>
                <div class="col-sm-9">
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    ...
                    <button class="btn btn-default" onclick="location.href='index.php?page=telkomakses'">Cancel</button>
                </div>
            </div>
        </footer>
        </form>
