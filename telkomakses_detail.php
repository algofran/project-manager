...
$qry = $conn->query("SELECT * FROM tbl_telkomakses where id = ".$_GET['pid'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
    ...
    <section class="panel panel-featured panel-featured-primary">				
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">							
                    <dl>
                        <dt><b class="border-bottom border-primary">Nama/Uraian</b></dt>
                        <dd><p class="text-primary text-bold"><?php echo ucwords($keterangan) ?></p></dd>
                    </dl>
                </div>
                <div class="col-md-3">
                <dl>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php $exp = $conn->query("SELECT sum(cost) as costs from telkomakses_exp where ta_id=".$id)->fetch_object()->costs ?>
    ...
    <section class="panel panel-featured panel-featured-danger">	
            <header class="panel-heading">
                ...
                <DIV class="col-md-6">
                    ...
                    <a class="btn btn-block btn-sm btn-default" href="./index.php?page=telkomakses_pengeluaran&pid=<?php echo $id ?>"><i class="fa fa-plus"></i> Tambah Pengeluaran</a>
                </div>
                </div>
                </div>
            </header>	
            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							<?php 
							$i = 1;
							$tasks = $conn->query("SELECT p.*,concat(u.firstname,' ',u.lastname) as uname FROM telkomakses_exp p left join users u on u.id = p.user_id where p.ta_id = {$id} order by p.date desc");
							...
							?>
								<tr id="<?php echo $row['id'] ?>">
			                        ...
			                        <td class="center actions-hover actions-fade">
                                        ...
                                        <a href="./index.php?page=telkomakses_exp_edit&id=<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></a>
                                        <a href="./telkomakses_exp_del.php?id=<?php echo $row['id'] ?>&pid=<?php echo $id ?>" onclick="return confirm('Anda yakin ingin menghapus item pengeluaran ini?')"><i class="fa fa-trash-o remove"></i></a>
                                    </td>
		                    	</tr>
							<?php 
							endwhile;
